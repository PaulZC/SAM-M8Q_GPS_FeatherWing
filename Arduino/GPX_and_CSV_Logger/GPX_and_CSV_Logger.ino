...
void setup()
{
  ...
  delay(2000); // Wait an extra 2 seconds for GNSS to restart
#endif
  delay(1100);
  while(Serial1.available()){Serial1.read();} // Flush RX buffer so we don't confuse GPS.parse with UBX acknowledgements
